...
export const metadata: Metadata = {
  title: "Notifications - SchemeMate AI",
  description: "View updates on government scheme matches, document alerts, deadline reminders, and status changes.",
};
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="text-left space-y-1.5 border-b border-gray-100 dark:border-slate-800 pb-4">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Stay updated with your matching schemes, deadlines, status changes, and announcements.
          </p>
        </div>
        <NotificationCenter />
      </div>
